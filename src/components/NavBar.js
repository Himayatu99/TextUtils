...
const NavBar = () => {
    return (
        <nav className='bg-orange-600 text-white flex justify-between'>
            <svg aria-hidden="true" className='h-12 px-5 pt-5' focusable="false" data-prefix="fas" data-icon="graduation-cap" class="w-7 h-7" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
